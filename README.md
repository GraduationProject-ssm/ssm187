...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1T48XecE9G?p=181)
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|8|huihua\_name|String|绘画名|是|
|9|huihua\_photo|String|绘画图片|是|
|10|huihua\_content|String|绘画内容|是|
|11|insert\_time|Date|绘画时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|13|single\_seach\_name|String|名字|是|
|14|single\_seach\_types|Integer|数据类型|是|
|15|single\_seach\_content|String|内容|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|17|wenxue\_name|String|文学名|是|
|18|wenxue\_photo|String|文学图片|是|
|19|wenxue\_content|String|文学内容|是|
|20|insert\_time|Date|绘画时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|22|wudao\_name|String|舞蹈名|是|
|23|wudao\_photo|String|舞蹈图片|是|
|24|wudao\_video|String|舞蹈视频|是|
|25|wudao\_content|String|舞蹈详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|31|yinyue\_name|String|音乐名|是|
|32|yinyue\_photo|String|音乐封面|是|
|33|yinyue\_music|String|音乐文件|是|
|34|yinyue\_content|String|音乐详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|36|yinyue\_id|Integer|音乐id|是|
|37|yonghu\_id|Integer|用户id|是|
|38|insert\_time|Date|收藏时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|40|yonghu\_name|String|用户姓名|是|
|41|sex\_types|Integer|用户性别|是|
|42|yonghu\_id\_number|String|用户身份证号|是|
